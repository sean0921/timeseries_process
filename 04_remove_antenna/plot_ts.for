...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +0 -G250/250/250 -Ey.05i/2/155 -P -K -O -V >> ",a10)')file(1),ps
            if(alive) write(11,'("psxy ",a15," -JX -R -Sc.03i -W2/255/0/
     ...
     +-G250/250/250 -P -K -O -V >> ",a10)')file(7),ps
            ...
            if(alive) write(11,'("psxy ",a15," -JX -R -W3/0 -P -K 
     +-O -V >> ",a10)')file(10),ps
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +        )ps
            ...
            if(alive) write(11,'("psxy ",a15," -JX -R -Sc.03i -W2/255/0/
     +0 -G250/250/250 -Ey.05i/2/155 -P -K -O -V >> ",a10)')file(2),ps
            if(alive) write(11,'("psxy ",a15," -JX -R -Sc.03i -W2/255/0/
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +        )ps
            ...
            if(alive) write(11,'("psxy ",a15," -JX -R -Sc.03i -W2/255/0/
     +0 -G250/250/250 -Ey.05i/2/155 -P -K -O -V >> ",a10)')file(3),ps
            if(alive) write(11,'("psxy ",a15," -JX -R -Sc.03i -W2/255/0/
     ...
     +-G250/250/250 -P -K -O -V >> ",a10)')file(9),ps
            ...
            if(alive) write(11,'("psxy ",a15," -JX -R -W3/0 -P -O 
     +-V >> ",a10)')file(12),ps
          end if
        end do
