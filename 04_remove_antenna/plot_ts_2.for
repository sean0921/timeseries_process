      ...
      do i=1,n
        ...
        file(1)='ts_'//site(i)//'_n_k.dat'
        file(2)='ts_'//site(i)//'_e_k.dat'
        file(3)='ts_'//site(i)//'_u_k.dat'
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +.3," -K -P -V2 -Y6.2i -X.8i > ",a10)'
            ...
            do k=1,neq
              ...
              write(11,'("gmt psxy sym -JX -R -W3,0ta -O -P -V2 -K >> ",
     +        a10)')ps
            end do
     ...
     +),ps
            ...
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -Sc.03i -W2,25
     +5/0/0 -G250/250/250 -Ey.05i/2,155 -P -K -O -V >> ",a10)')file(1),p
     +s
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -Sc.03i -W2,25
     +5/0/0 -G250/250/250 -P -K -O -V >> ",a10)')file(1),ps
            inquire(file=file(4),exist=alive)
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -Sc.03i -W2,0/
     ...
     +0/0 -G250/250/250 -P -K -O -V >> ",a10)')file(7),ps
            ...
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -W3,0 -P -K
     +-O -V >> ",a10)')file(10),ps
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +," -K -O -P -V2 -Y-1.95i -X0i >> ",a10)'
            ...
            do k=1,neq
              write(11,'("echo "f9.4,f10.3," >  sym")')teq(k),yminb
              write(11,'("echo "f9.4,f10.3," >> sym")')teq(k),ymaxb
              write(11,'("gmt psxy sym -JX -R -W3,0ta -O -P -V -K >> ",a
     +        10)')ps
            end do
            inquire(file=file(2),exist=alive)
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -Sc.03i -W2,25
     +5/0/0 -G250/250/250 -Ey.05i/2,155 -P -K -O -V >> ",a10)')file(2),p
     +s
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -Sc.03i -W2,25
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +        10)')ps
            ...
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -Sc.03i -W2,25
     +5/0/0 -G250/250/250 -Ey.05i/2,155 -P -K -O -V >> ",a10)')file(3),p
     +s
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -Sc.03i -W2,25
     ...
     +0/0 -G250/250/250 -P -K -O -V >> ",a10)')file(9),ps
            ...
            if(alive) write(11,'("gmt psxy ",a15," -JX -R -W3,0 -P -O
     +-V >> ",a10)')file(12),ps
          end if
        end do
