      ...
      do c=1,3
        ...
        do k=1,t1
          ...
          if(nt<4) then
            ...
            write(10,'(f10.5," Number of stations: ",i1," < 4 !!")')rt(k),nt
            close(10)
          end if
          if(nt<2) cycle
          err=err/real(nt)
...
c.......................................................................
      ...
      double precision,allocatable::t(:),g(:,:),d(:),w(:),m(:),sg(:),teq(:),ce(:),cn(:),ch(:),ces(:),cns(:),chs(:),pve(:),pvn(:),pvh(:),pves(:),pvns(:),pvhs(:),std(:),cal(:)
